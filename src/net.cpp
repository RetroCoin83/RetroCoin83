...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "RETROCOIN83 " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"104.31.86.52", "95.211.57.108:4715"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. RETROCOIN83 is probably already running."), addrBind.ToString().c_str());
        else
