...
#if defined(NDEBUG)
# error "RETROCOIN83 cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x075b3c3fcc45c9ee991bab977a26fe3275b672cfd97ab972bd1a9f4898289bd3");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // RETROCOIN83: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "RETROCOIN83 Signed Message:\n";
...
{
    // RETROCOIN83: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 83 * 60;
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // RETROCOIN83: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // RETROCOIN83: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x075b3c3fcc45c9ee991bab977a26fe3275b672cfd97ab972bd1a9f4898289bd3");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1440963246, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "30/Aug/2015 Retro83 Scrypt 2015";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 83 * COIN;
        ...
        assert(block.hashMerkleRoot == uint256("0xd200486857b5136efa94c362ecb05d3769ad21635585f3906c2baa95fe23da3b"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // RETROCOIN83: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("RETROCOIN83Miner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("RETROCOIN83Miner : ProcessBlock, block not accepted");
    }

    return true;
}

void static RETROCOIN83Miner(CWallet *pwallet)
{
    printf("RETROCOIN83Miner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("retrocoin83-miner");
    ...
    try { loop {
        ...
        printf("Running RETROCOIN83Miner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("RETROCOIN83Miner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&RETROCOIN83Miner, pwallet));
}
